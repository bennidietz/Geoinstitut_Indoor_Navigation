...
const strings = {
    ...
    "qr_expl_step3": ["Sobald die Kamera den QR-Code erkannt wird poppt ein Fenster mit der Referenz auf den Link auf. <b>Öffnen Sie dieses Fenster.</b>", "As soon as the camera recognized the QR-Code a window appears with the reference of the link saved in the QR-Code. <b>Open this window</b>", ""],
    ...
    "take_stairs_elevator": ["Bitte nehmen Sie %s1 ins %s2", "Please take %s1 to %s2"],
